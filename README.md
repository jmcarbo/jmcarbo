...
- ⚡ **Token-efficient agent runtimes**: cut 25 tool definitions from ~2,400 tokens of JSON Schema down to 160 tokens; collapsed a five-tool chain from 7 LLM round trips to 1.
- ✅ **Quality at scale**: raised Go test coverage from 64.9% to 90.1% across a 1,100-file suite.
- Built the **celonix-go SDK** with an integrated MCP server.

## Featured open source

- **[fullmcp](https://github.com/jmcarbo/fullmcp)** — Production-ready Go implementation of the Model Context Protocol.
...
- **[awiki](https://github.com/jmcarbo/awiki)** — LLM-maintained knowledge base with hybrid BM25 + vector retrieval, RRF fusion and reranking.
